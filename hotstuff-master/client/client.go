...
func (c *Client) Run(ctx context.Context) {
	...
	var input []string = []string{"i am a healthy person ...................", "i am not a healthy person ...................", "i am a pretty person .................."}
	//var input string="i am a healthy person ..................."
	err := c.sendCommands(ctx, input)

	if err != nil && !errors.Is(err, io.EOF) {
		c.mods.Logger().Panicf("Failed to send commands: %v", err)
	}

	/*	input="i am not healthy person ..................."
		err = c.sendCommands(ctx,input)
		if err != nil && !errors.Is(err, io.EOF) {
			c.mods.Logger().Panicf("Failed to send commands: %v", err)
		}*/
...
func (c *Client) sendCommands(ctx context.Context, inarray []string) error {
	var (
		num         uint64 = 1
...
loop:
	for _, input := range inarray {
		...
		data := make([]byte, c.payloadSize)
		//var input string="i am healthy person ..................."
		stringreader := strings.NewReader(input)
		bufReader := bufio.NewReaderSize(stringreader, 64)
		...
		num++
		//fmt.Printf("input command exected is : %s\n" ,input)
		select {
